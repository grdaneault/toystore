...
public class StoreHoursTable extends Table {
	...
	public StoreHoursTable(Store store)
	{
		super();
		this.store = store;
	...
	public void save()
	{
		...
		for (Object row : c.getItemIds())
		{
			String open = (String)((NativeSelect)c.getItem(row).getItemProperty("open").getValue()).getValue();
			String close = (String)((NativeSelect)c.getItem(row).getItemProperty("close").getValue()).getValue();
			
			DayHour dh = (DayHour)row;
			dh.setOpen_string(open);
			dh.setClose_string(close);
	...
	public void reset() {
		...
		{
			DayHour dh = (DayHour)row;
			((NativeSelect)c.getItem(row).getItemProperty("open").getValue()).setValue(dh.getOpen_string());
			((NativeSelect)c.getItem(row).getItemProperty("close").getValue()).setValue(dh.getClose_string());
		}
